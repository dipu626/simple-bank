...
// Source: github.com/dipu626/simple-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetRandomAccount(arg0 context.Context) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRandomAccount", arg0)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) GetRandomAccount(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRandomAccount", reflect.TypeOf((*MockStore)(nil).GetRandomAccount), arg0)
}
