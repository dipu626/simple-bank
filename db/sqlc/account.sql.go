...
UPDATE accounts a SET balance = balance + $1 WHERE a.id = $2 RETURNING id, owner, balance, currency, created_at
`
...
SELECT id, owner, balance, currency, created_at FROM accounts a
